...
```{r bilder, echo=FALSE,out.width="49%", out.height="20%",fig.cap="Left side: NASA / Chris Hadfield. Right side: my version with connections serviced by trams in red. ",fig.show="hold",fig.align="center"}
